...
> - обновил данные `UserMealsUtil.userMeals` и переименовал некоторые переменные, поля и методы
...
- через Stream API за 1 проход по исходному списку `userMeals.stream()`
